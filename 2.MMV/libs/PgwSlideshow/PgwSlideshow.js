 ...
 (function(a) {
     a.fn.pgwSlideshow = function(q) {
         ...
         var h = function(r, s) {
             ...
             //Region P5s set maxHeight
             j.config.maxHeight = 450;
             r = 450;
             //EndRegion P5s set maxHeight
         ...
         var g = function() {
             ...
             //src="small/image1.png" data-zoom-image="large/image1.jpg" - See more at: http://www.elevateweb.co.uk/image-zoom#sthash.MCiVdlxW.dpuf
             var r = 1;
             j.plugin.find(".ps-list > ul > li").each(function() {
                 ...
                 var s = a('<li class="elt_' + r + '" id="P5selt_'+r+'"></li>');
                 if (t.image) {
                     s.html('<img  src="' + t.image + '" data-zoom-image="' + t.image + '" id="Pgwimg_'+ r +'" alt="' + (t.title ? t.title : "") + '">')
                 } else {
                     if (t.thumbnail) {
                         s.html('<img   src="' + t.thumbnail + '" data-zoom-image="' + t.thumbnail + '" id="Pgwimg_'+ r + '" alt="' + (t.title ? t.title : "") + '">')
                     }
                 }
                 if (t.link) {
         ...
         var n = function() {
             ...
             if ((u < w) || (s > r) || (z > A && r > s)) {
                 var v = -(z - A);
                 if (-u < v) {
                     y.css("left", 0) //P5s remove css left
                 } else {
                     y.css("left", 0)//P5s remove css left
                 }
             }
             ...
             //P5s gọi hàm load các giá trị mặt định cho trang CustomerPhoto
            try 
            {
                var selected = j.plugin.find(".ps-list .ps-selected").children();
                P5sLoadDefaultDataForCustomerPhoto(selected[0].id);                
            }
            catch(err) {
