<%@ Page Language="C#" MasterPageFile="~/P5s2.Master" AutoEventWireup="true" CodeBehind="ImportSalesTarget.aspx.cs"
    Inherits="MMV.ImportSalesTarget" %>
        ...
        <asp:UpdatePanel ID="P5sUpanelSearch" runat="server">
            <ContentTemplate>
                <table cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color: #D0D0D0">
                    <tr>
                        <td style="min-width: 600px" colspan="7"></td>
                    </tr>
                    <tr>
                        <td colspan="6">&nbsp
                        </td>
                    ...
                    <tr>
                        <td style="width: 20%" class="sectionheader"><%=MMV.L5sMaster.L5sLangs["Search"]%></td>
                        <td>
                        ...
                        <td style="width: 1%">
                            ...
                            <asp:LinkButton ID="P5sLbtnExportTemplate" runat="server" CausesValidation="False"
                                OnClick="P5sLbtnExportTemplate_Click"><%=MMV.L5sMaster.L5sLangs["Export Template Import"]%></asp:LinkButton>
        ...
        <asp:UpdatePanel ID="P5sUpanelMain" runat="server">
            <ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="5px" border="0" width="100%">
                    ...
                    <tr>
                        <td style="white-space: nowrap; width: 1%; vertical-align: top;"><%=MMV.L5sMaster.L5sLangs["Upload list of customer"]%><span style="color: Red;">* </span>:&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
                        </td>
