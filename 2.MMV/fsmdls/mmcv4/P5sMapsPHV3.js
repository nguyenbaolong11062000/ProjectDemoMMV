    ...
    function CreateMarker(pt, Object, icon, m)
    {
       ...
       // console.log(markerStart);
         ...
         if (markerStart == undefined || markerStart != markerTmp) {
                ...
                if (markerStart.LONGITUDE_LATITUDE == markerTmp.LONGITUDE_LATITUDE) {
                    str = str.replace("{100}", arrowDownOption);
                }


            //End Point
            if (markerEnd == undefined || markerEnd.LONGITUDE_LATITUDE != markerTmp.LONGITUDE_LATITUDE) {
          ...
          //  else {
                ...
                str = str.replace("{20}", obj.DISTRIBUTOR_DISTANCE + " Km");
            //}
...
function ClassMarkerLongTude(myMap, pathImage, StrObject) {
    ...
    function c() {
        for (var i = 0; i < this.VMarkers.length; i++) {
           ...
           this.VMarkers[i].setVisible(true);
           this.VMarkers[i].setMap(myMap);
        }
        this.IsMarkerShow = true;
    }
    ...
    function b(v, p, m) {
        ...
        for (var i = 0; i < object.length; i++) {
           ...
           // var obj = object[i];
            mar.addListener('click', function () {
          //  alert("ClassMarkerLongTude");
             var index =  markers.indexOf(this);    
            var object2 = $.parseJSON(v);        
            var obj = object2[index];  
                markerMoveTmp = obj;
                ...
                if (CTracking.prototype.mInfowindow == null){
                 CTracking.prototype.mInfowindow = new Array();
                }
                else{
                for (var i = 0; i < CTracking.prototype.mInfowindow.length; i++) {
...
function ClassMarkerCentralPoint(myMap, pathImage, StrObject) {
    ...
    function c() {
        for (var i = 0; i < this.VMarkers.length; i++) {
        //alert(this.VMarkers[i].innerHTML);
            //this.VMarkers[i].show();
            this.VMarkers[i].setVisible(true);
            this.VMarkers[i].setMap(myMap);
        }
    ...
    function b(v, p, m) {
        ...
        for (var i = 0; i < object.length; i++) {
           ...
           // alert("ClassMarkerCentralPoint");
                ...
                var arrowDownOption = 'src=\"icon/arrowOptionDown.png\"';
               // console.log(obj);
                if (mar.icon == "/icon/centralPoint.png") {
                    str = str.replace("{100}", arrowOption);
                    str = str.replace("{Select}", "Select");
                }
                else {
             ...
             //   console.log(CTracking.prototype);
              //  alert(CTracking.prototype.mInfowindow.length);
              else{
                for (var i = 0; i < CTracking.prototype.mInfowindow.length; i++) {
                //console.log(CTracking.prototype.mInfowindow[i]);
                    CTracking.prototype.mInfowindow[i].close();
                }
                 CTracking.prototype.mInfowindow = new Array();
                }
...
function fnsViewDistance() {
    ...
    var latlng = markerStartViewDistance.LONGITUDE_LATITUDE.split(/, ?/);
    var startLatLng = new google.maps.LatLng(parseFloat(latlng[0]), parseFloat(latlng[1]));
    var latlng2 = markerViewDistance.LONGITUDE_LATITUDE.split(/, ?/);
    ...
    document.getElementById("ResultViewDistance").innerText = "==> " + distance + " Km";
...
function ClassMarkerDistributorInDirect(myMap, pathImage, StrObject) {
    ...
    function CreateMarker(pt, Object, icon, m)
    {
        ...
        mar.addListener('click', function () {
            markerTmp = Object;
            obj = Object;
        //    alert("ClassMarkerDistributorInDirect");
            //console.log(obj);
            var str = '';
            str += '       <table style=\"font-family:Tahoma; font-size:11px;width: 375px;text-align:left\" cellpadding=\"0\" cellspacing=\"2\" border=\"0\" width=\"100%\">';
            str += '                    <tr>';
...
function ClassMarkerDistributorNetworkDirect(myMap, pathImage, StrObject) {
    ...
    function CreateMarker(pt, Object, icon, m) {
        ...
        mar.addListener('click', function () {
            obj = Object;
          //  alert("ClassMarkerDistributorNetworkDirect");
       //  console.log(obj);
            markerTmp = obj;
            markerViewDistance = obj;
            markerMoveTmp = obj;
            ...
            //Start Point
            if (distributorSelectMove == undefined || distributorSelectMove.LONGITUDE_LATITUDE != markerTmp.LONGITUDE_LATITUDE) {
                str = str.replace("{100}", arrowOption);
            } else
                if (distributorSelectMove.LONGITUDE_LATITUDE == markerTmp.LONGITUDE_LATITUDE) {
                    str = str.replace("{100}", arrowDownOption);
                }
            ...
            if (obj.DistributorTypeImage == "/icon/ND.png") {
        ...
        for (var i in object){
           ...
           // console.log(object[1]);       
            ...
            var obj = object2[index];           
                ...
                //Select NPP Select  
               // console.log(obj);                  
                if (mar.DistributorTypeImage == "/icon/SD.png") {
                    str = str.replace("{105}", arrowOption);
                    str = str.replace("{Select}", "Select");
                }
                else {
