<%@ Page Title="" Language="C#" MasterPageFile="~/P5s.Master" AutoEventWireup="true" CodeBehind="PrimaryInvoiceSalesPerformance.aspx.cs" Inherits="MMV.Dashboard.PrimaryInvoiceSalesPerformance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function drawRegionChart() {
            $.ajax({
                ...
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'REGION', colSum: 'INVOICE_SALES', orderBy: 'INVOICE_SALES DESC', table: 'D_YTD_SALES_DATA_PRI'}",
        ...
        function drawSubCatgChart() {
            $.ajax({
                type: "POST",
                url: "/Dashboard/ChartService.asmx/OnClickChar",
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'SUB_CATG', colSum: 'INVOICE_SALES', orderBy: 'INVOICE_SALES DESC', table: 'D_YTD_SALES_DATA_PRI'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    var gglData = dataArray(result.d);
        ...
        function drawYearChart() {
            $.ajax({
                type: "POST",
                url: "/Dashboard/ChartService.asmx/OnClickChar",
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'YEAR', colSum: 'INVOICE_SALES', orderBy: 'YEAR', table: 'D_YTD_SALES_DATA_PRI'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    var gglData = dataArray(result.d);
        ...
        function drawBrandChart() {
            $.ajax({
                type: "POST",
                url: "/Dashboard/ChartService.asmx/OnClickChar",
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'BRAND', colSum: 'INVOICE_SALES', orderBy: 'INVOICE_SALES DESC', table: 'D_YTD_SALES_DATA_PRI'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    var gglData = dataArray(result.d);
        ...
        function setLabelGrowth() {
            $.ajax({
                ...
                data: "{ filter: '' , colFilter: 'REGION', colSum: 'INVOICE_SALES', table: 'D_YTD_SALES_DATA_PRI'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
        ...
        function slMonthChanged(value) {
            google.setOnLoadCallback(function () { classChangePri(value, "MONTH") });
        }
        ...
        $(() => {
            ...
            $.ajax({
                ...
                data: "{ table:'D_YTD_SALES_DATA_PRI'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    // console.log(result.d);
    ...
    <form id="frmMain" runat="server">
        <%--onclick="javascript:SaveWithParameter()"--%>
        ...
        <asp:UpdatePanel ID="P5sUpanelMain" runat="server">
            <ContentTemplate>
                <asp:Panel ID="P5sPnlMain" runat="server">
                    ...
                    <h4 style="color: #808080"><%=MMV.L5sMaster.L5sLangs["Primary Invoice Sale Perfomance - YTD (Mil)"]%></h4>
