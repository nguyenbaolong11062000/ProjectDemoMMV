...
{
    public partial class PrimaryInvoiceSalesPerformance : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                L5sJS.L5sRun("drawRegionChart(); drawSubCatgChart(); drawYearChart(); drawBrandChart(); setLabelGrowth(); setLabelYTD();");
            }
        ...
        protected void P5sLbtnRemoveSession_Click(object sender, EventArgs e)
        {
            ...
            Session.Remove("MONTH");
            Session.Remove("NAME");
            L5sJS.L5sRun("drawRegionChart(); drawSubCatgChart(); drawYearChart(); drawBrandChart(); setLabelGrowth(); setLabelYTD();fadeOut();");
            slMonth.DataSource = L5sSql.Query(@"SELECT 
	                                                distinct 
													MONTH AS VALUE
													, 
