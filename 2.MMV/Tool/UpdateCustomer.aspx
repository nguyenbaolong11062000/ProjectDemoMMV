<%@ Page Language="C#" MasterPageFile="~/P5s2.Master" AutoEventWireup="true" CodeBehind="UpdateCustomer.aspx.cs" Inherits="MMV.Tool.UpdateCustomer" %>
        ...
        <asp:UpdatePanel ID="P5sUpanelMain" runat="server">
            <ContentTemplate>
                ...
                <table cellpadding="0" cellspacing="5px" border="0" width="100%">
                    <tr>
                        <td style="white-space: nowrap; vertical-align: top; width: 189px;">
                            Upload list of customers<span style="color: Red;">* </span>:
                        </td>
                        <td style="white-space: nowrap; vertical-align: top;">
                            <asp:FileUpload ID="P5sFileUpload" runat="server" style="margin-left: 0px" Width="201px" />
                        </td>
                        ...
                        <tr>
                            <td colspan="4" style="white-space: nowrap; width: 1%; vertical-align: top;"><span style="color: Red;">Note : when upload system will not update ward/commune if this information is empty.</span> </td>
                        </tr>
