...
{
    public partial class YTDPrimarySalesPerformanceTH : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                Session["Where"] = "(1=1)";
                LoadSelectMonth();
                L5sJS.L5sRun(@"google.charts.setOnLoadCallback(drawRegionChartTH);
                            google.charts.setOnLoadCallback(drawSubCatgChartTH);
                            google.charts.setOnLoadCallback(drawYearChartTH);
                            google.charts.setOnLoadCallback(drawDistributorChartV2_TH);
                            google.charts.setOnLoadCallback(drawBrandChartTH);setLabelGrowthTH(); setLabelYTD_TH();");
            }
            else
            {
            ...
            Session.Remove("NAME");
            L5sJS.L5sRun("drawRegionChartTH(); drawSubCatgChartTH(); drawYearChartTH(); drawBrandChartTH(); setLabelGrowthTH(); setLabelYTD_TH();drawDistributorChartV2_TH();");
        ...
        private void LoadSelectMonth()
        {
            if (IsPostBack)
                return;
            slMonth.DataSource = L5sSql.Query(@"	SELECT distinct 
													month AS VALUE, 
        ...
        protected void P5sLbtnRemoveSession_Click(object sender, EventArgs e)
        {
            ...
            Session.Remove("YEAR");
            Session.Remove("MONTH");
            L5sJS.L5sRun("drawRegionChartTH(); drawSubCatgChartTH(); drawYearChartTH(); drawBrandChartTH(); setLabelGrowthTH(); setLabelYTD_TH();fadeOut();drawDistributorChartV2_TH");
            slMonth.DataSource = L5sSql.Query(@"    SELECT distinct 
													month AS VALUE, 
	                                                RIGHT(MONTH,3) as MONTH,
													CASE
