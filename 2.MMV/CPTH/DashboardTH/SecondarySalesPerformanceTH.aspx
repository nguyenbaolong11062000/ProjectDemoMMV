<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/P5s.Master" CodeBehind="SecondarySalesPerformanceTH.aspx.cs" Inherits="MMV.CPTH.DashboardTH.SecondarySalesPerformanceTH" %>
    ...
    <script type="text/javascript">
        ...
        function drawDistributorChart() {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (Array.isArray(gglData) && gglData.length) {
                        GetdataSecondaryChartCPTH(result.d, options, "Distributor", "Bar");
                    } else {
        ...
        function drawDistributorChartV2() {
            $.ajax({
                ...
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'NAME', colSum: 'ACTUAL', orderBy: 'ACTUAL DESC', table: 'D_MTD_SECONDATY_SALES_UPDATE',ACTUAL: 'ACTUAL',TARGET :'TARGET'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    var gglData = dataArrayCPTH(result.d);
        ...
        function drawDSRChart() {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (Array.isArray(gglData) && gglData.length) {
                        GetdataSecondaryChartCPTH(result.d, options, "DSR", "Bar");
                    } else {
        ...
        function drawDSRChartV2() {
            $.ajax({
                type: "POST",
                url: "/Dashboard/ChartService.asmx/OnClickCharV2",
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'DSR_NAME', colSum: 'ACTUAL', orderBy: 'ACTUAL DESC', table: 'D_MTD_SECONDATY_SALES_UPDATE',ACTUAL: 'ACTUAL',TARGET :'TARGET'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    var gglData = dataArrayCPTH(result.d);
        ...
        function slAreaChanged(value) {
            google.setOnLoadCallback(function () { classChangeSecondaryCPTH(value, "AREA") });
        }
            ...
            <ContentTemplate>
                <asp:Panel ID="P5sPnlMain" runat="server">
                    ...
                    <div class="dhb-body">
                        ...
                        <%--  <div class="dhb-body_sub-1 box-shadow">
                            <asp:Label class="title-chart" runat="server"><%=MMV.L5sMaster.L5sLangs["Area"]%></asp:Label>
                            <select class="input-sm" style="width: 100%; height: 95%;" id="slArea" runat="server" multiple="true">
                            </select>
                        </div>
                        <div class="dhb-body_sub-2">
                            <div class="dhb-body_sub-2_1 box-shadow">
                            ...
                            <div class="dhb-body_sub-2_2 box-shadow" style="margin-top: 3%">
                        ...
                        <div class="dhb-body_sub-3">
                            ...
                            <div class="dhb-dhb-body_sub-3_2 box-shadow">
                                
                            </div>
                            <div class="dhb-dhb-body_sub-3_3 box-shadow">
