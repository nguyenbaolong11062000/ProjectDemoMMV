...
function classChangeCPTH(filter, colHeader) {
    ...
    setTimeout(function () {
        ...
        $.ajax({
            ...
            dataType: "json",
            success: function (result) {
                // alert("filter -" + filter + " VS colHeader -" + colHeader);
        ...
        $.ajax({
            type: "POST",
            url: "/Dashboard/ChartService.asmx/OnClickChar",
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', Cols: 'YEAR', colSum: 'GROSS_SALES_MLI', orderBy: 'YEAR asc', table: 'D_YTD_SALES_DATA_SEC'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
...
//-------------------------Code for sellout chart--------------------------------------
function GetDataSelloutChart(json, options, div, chartType) {
    // Load the Visualization API and the corechart package.
    // Set a callback to run when the Google Visualization API is loaded.
    //Convert Json to array
    var gglData = dataArrayCPTH(json);
    var data = new google.visualization.arrayToDataTable(gglData);
    drawSelloutChart(data, options, div, chartType);
    // Callback that creates and populates a data table,
    // instantiates the pie chart, passes in the data and
    // draws it.
}

function drawSelloutChart(data, options, div, chartType) {
    var chart = [];
    var view;
    if (chartType === "Pie") {
        chart = new google.visualization.PieChart(document.getElementById(div));
    ...
    function ClickHandler() {
        ...
        if (colHeader == 'YEAR') {
            ...
            classChangeSellout(filter, colHeader);
        }
...
function classChangeSellout(filter, colHeader) {
    $(".loader-wrapper").fadeIn('fast');
    setTimeout(function () {
        //Sellout - Year
        $.ajax({
...
function GetDataMTDandTargetChart(json, options, div, chartType) {
    // Load the Visualization API and the corechart package.
    // Set a callback to run when the Google Visualization API is loaded.
    //Convert Json to array
    var gglData = dataArrayCPTH(json);
    var data = new google.visualization.arrayToDataTable(gglData);
    drawMTDandTargetChart(data, options, div, chartType);
    // Callback that creates and populates a data table,
    // instantiates the pie chart, passes in the data and
    // draws it.
}

function drawMTDandTargetChart(data, options, div, chartType) {
    var chart = [];
    var view;
    if (chartType === "Pie") {
        chart = new google.visualization.PieChart(document.getElementById(div));
    ...
    function ClickHandler() {
        ...
        if (colHeader == 'Coverage')
            return;
        classChangeMTDandTarget(filter, colHeader);
    }
    google.charts.setOnLoadCallback(
        function () {
            setTimeout(function () {
...
function classChangeMTDandTarget(filter, colHeader) {
    $(".loader-wrapper").fadeIn('fast');
    setTimeout(function () {
        $.ajax({
            type: "POST",
...
function GetDataDistributorDailySummary(json, options, div, chartType) {
    // Load the Visualization API and the corechart package.
    // Set a callback to run when the Google Visualization API is loaded.
    //Convert Json to array
    var gglData = dataArrayCPTH(json);
    var data = new google.visualization.arrayToDataTable(gglData);
    drawDistributorDailySummary(data, options, div, chartType);
    // Callback that creates and populates a data table,
    // instantiates the pie chart, passes in the data and
    // draws it.
}

function drawDistributorDailySummary(data, options, div, chartType) {
    var chart = [];
    var view;
    if (chartType === "Pie") {
        chart = new google.visualization.PieChart(document.getElementById(div));
    ...
    function ClickHandler() {
        ...
        if (colHeader == 'Coverage')
            return;
        classChangeDistributorDailySummary(filter, colHeader);
    }
    google.charts.setOnLoadCallback(
        function () {
            setTimeout(function () {
...
function classChangeDistributorDailySummary(filter, colHeader) {
    $(".loader-wrapper").fadeIn('fast');
    setTimeout(function () {
        $.ajax({
            type: "POST",
            ...
            success: function (result) {
                ...
                document.getElementById('Actual-value').innerHTML = formatNumber(arrayItem[0]);
                document.getElementById('Target-value').innerHTML = formatNumber(arrayItem[0] + arrayItem[1]);
                var options = {
                    slices: {
                        o: {},
                        1: { color: '#F0F5F7' }
        ...
        $.ajax({
            type: "POST",
            url: "/Dashboard/ChartService.asmx/OnClickCharV4",
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', Cols: 'DSR', colSum: 'ACTUAL', orderBy: 'DSR', table: 'D_MTD_ACT_TARGET'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result, status, xhr) {
                var gglData = dataArrayCPTH(result.d);
...
//---------------------------YEAR TO DATE PRIMARY THAI LAN---------------------------
// 28/09/2020

function GetdataChartCPTH_PRI(json, options, div, chartType) {
    // Load the Visualization API and the corechart package.
    // Set a callback to run when the Google Visualization API is loaded.
    //Convert Json to array
    var gglData = dataArrayCPTH(json);
    if (Array.isArray(gglData) && gglData.length) {}
    var data = new google.visualization.arrayToDataTable(gglData);
    drawChartCPTH_PRI(data, options, div, chartType);
    // Callback that creates and populates a data table,
    // instantiates the pie chart, passes in the data and
    // draws it.
    // Create the data table
...
function drawChartCPTH_PRI(data, options, div, chartType) {
    var chart = [];
    var view;
    if (chartType === "Pie") {
        chart = new google.visualization.PieChart(document.getElementById(div));
        ...
        //console.log(view);
        chart = new google.visualization.ColumnChart(document.getElementById(div));
        var formatterBath = new google.visualization.NumberFormat({ suffix: ' ฿', pattern: '#,###' });
        formatterBath.format(data, 1); // Apply formatter to one column
    }
    else if (chartType === "Line") {
        chart = new google.visualization.LineChart(document.getElementById(div));
    ...
    function ClickHandler() {
        ...
        row = selectedData[0].row;
        var filter = view.getValue(row, 0);
        classChangeCPTH_PRI(filter, colHeader);
    }
}

function classChangeCPTH_PRI(filter, colHeader) {
    $(".loader-wrapper").fadeIn('fast');
    setTimeout(function () {
        $.ajax({
            type: "POST",
            url: "/Dashboard/ChartService.asmx/OnClickChar_PRI_TH",
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', Cols: 'REGION', colSum: 'GROSS_SALES_MLI', orderBy: 'GROSS_SALES_MLI DESC', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
                var gglData = dataArrayCPTH(result.d);
                ...
                GetdataChartCPTH_PRI(result.d, options, "Region", "Pie");
                if (Array.isArray(gglData) && gglData.length) {
        ...
        $.ajax({
            type: "POST",
            url: "/Dashboard/ChartService.asmx/getGrowthV2_PRI_TH",
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', Cols: 'NAME', colSum: 'GROSS_SALES_MLI', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
                var gglData = dataArrayCPTH(result.d);
                ...
                if (Array.isArray(gglData) && gglData.length) {
                    GetdataChartCPTH_PRI(result.d, options, "Distributor", "Combo");
                } else {
                    //erros = erros + "No data Distributor, ";
                    // document.getElementById("errors").innerText="asdasd";
                }
        ...
        $.ajax({
            type: "POST",
            url: "/Dashboard/ChartService.asmx/OnClickChar_PRI_TH",
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', Cols: 'SUB_CATG', colSum: 'GROSS_SALES_MLI', orderBy: 'GROSS_SALES_MLI DESC', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
                var gglData = dataArrayCPTH(result.d);
                ...
                GetdataChartCPTH_PRI(result.d, options, "SubCatg", "Column");
                if (Array.isArray(gglData) && gglData.length) {}
            },
            error: function (result, status, error) {
                var err = eval("(" + result.responseText + ")");
        ...
        $.ajax({
            type: "POST",
            url: "/Dashboard/ChartService.asmx/OnClickChar_PRI_TH",
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', Cols: 'YEAR', colSum: 'GROSS_SALES_MLI', orderBy: 'YEAR asc', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
                var object = JSON.parse(result.d);
                ...
                GetdataChartCPTH_PRI(data, options, "Year", "Column");
                if (Array.isArray(gglData) && gglData.length) {}
            },
            error: function (result, status, error) {
                var err = eval("(" + result.responseText + ")");
        ...
        $.ajax({
            type: "POST",
            url: "/Dashboard/ChartService.asmx/OnClickChar_PRI_TH",
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', Cols: 'YEAR', colSum: 'GROSS_SALES_MLI', orderBy: 'YEAR', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
                var gglData = dataArrayCPTH(result.d);
                ...
                if (Array.isArray(gglData) && gglData.length) {
                    GetdataChartCPTH_PRI(result.d, options, "Year", "Combo");
                } else {
                    // erros = "No data Year, ";
                }
            },
        ...
        $.ajax({
            type: "POST",
            url: "/Dashboard/ChartService.asmx/OnClickChar_PRI_TH",
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', Cols: 'BRAND', colSum: 'GROSS_SALES_MLI', orderBy: 'GROSS_SALES_MLI DESC', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
                var gglData = dataArrayCPTH(result.d);
                ...
                GetdataChartCPTH_PRI(result.d, options, "Brand", "Column");
                if (Array.isArray(gglData) && gglData.length) {}
            },
            error: function (result, status, error) {
                var err = eval("(" + result.responseText + ")");
        ...
        $.ajax({
            type: "POST",
            url: "/Dashboard/ChartService.asmx/getGrowth_PRI_TH",
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', colSum: 'GROSS_SALES_MLI', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
                var obj = JSON.parse(result.d);
        ...
        $.ajax({
            type: "POST",
            url: "/Dashboard/ChartService.asmx/getYTD_PRI_TH",
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', colSum: 'GROSS_SALES_MLI', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
...
//---------------------------END YEAR TO DATE PRIMARY THAI LAN---------------------------

//---------------------------MONTH TO DATE PRIMARY THAI LAN---------------------------
// 29/09/2020

function GetdataSecondaryChartCPTH_PRI_MON(json, options, div, chartType) {
    // Load the Visualization API and the corechart package.
    // Set a callback to run when the Google Visualization API is loaded.
    //Convert Json to array
    var gglData = dataArrayCPTH(json);
    ...
    // Create the data table
    var data = new google.visualization.arrayToDataTable(gglData);
    drawSecondaryChartCPTH_PRI_MON(data, options, div, chartType);
}

function drawSecondaryChartCPTH_PRI_MON(data, options, div, chartType) {
    var chart = [];
    var view;
    if (chartType === "Pie") {
        chart = new google.visualization.PieChart(document.getElementById(div));
    ...
    function ClickHandler() {
        ...
        row = selectedData[0].row;
        var filter = view.getValue(row, 0);
        classChangeSecondaryCPTH_PRI_MON(filter, colHeader);
    }
}

function classChangeSecondaryCPTH_PRI_MON(filter, colHeader) {
    $(".loader-wrapper").fadeIn('fast');
    setTimeout(function () {
        $.ajax({
            type: "POST",
        ...
        $.ajax({
            ...
            data: "{ filter: '" + filter + "' , colFilter: '" + colHeader + "', Cols: 'NAME', colSum: 'ACTUAL', orderBy: 'ACTUAL DESC', table: 'D_MTD_PRIMARY_UPDATE',ACTUAL: 'ACTUAL',TARGET :'TRGET'}",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            success: function (result) {
                var gglData = dataArrayCPTH(result.d);
    ...
    //---------------------------END MONTH TO DATE PRIMARY THAI LAN---------------------------
}
