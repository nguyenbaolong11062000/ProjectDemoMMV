<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/P5s.Master" CodeBehind="YTDPrimarySalesPerformanceTH.aspx.cs" Inherits="MMV.CPTH.DashboardTH.YTDPrimarySalesPerformanceTH" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        ...
        function drawRegionChartTH() {
            $.ajax({
                type: "POST",
                url: "/Dashboard/ChartService.asmx/OnClickChar_PRI_TH",
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'REGION', colSum: 'GROSS_SALES_MLI', orderBy: 'GROSS_SALES_MLI DESC', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
        ...
        function drawDistributorChartV2_TH() {
            $.ajax({
                ...
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'NAME', colSum: 'GROSS_SALES_MLI', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
        ...
        function drawSubCatgChartTH() {
            $.ajax({
                type: "POST",
                url: "/Dashboard/ChartService.asmx/OnClickChar_PRI_TH",
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'SUB_CATG', colSum: 'GROSS_SALES_MLI', orderBy: 'GROSS_SALES_MLI DESC', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    var gglData = dataArrayCPTH(result.d);
        ...
        function drawYearChartTH() {
            $.ajax({
                type: "POST",
                url: "/Dashboard/ChartService.asmx/OnClickChar_PRI_TH",
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'YEAR', colSum: 'GROSS_SALES_MLI', orderBy: 'YEAR asc', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    ...
                    //console.log("13213:", year);
                    //console.log("ban dau: ", object);
                    for (let val in object) {
                        if ((year - 1) > object[val]["YEAR"] ) {
                            object.splice(val, 1);
                        } 
                    }
                    console.log("sau for: ", object);
        ...
        function drawBrandChartTH() {
            $.ajax({
                type: "POST",
                url: "/Dashboard/ChartService.asmx/OnClickChar_PRI_TH",
                data: "{ filter: '' , colFilter: 'REGION', Cols: 'BRAND', colSum: 'GROSS_SALES_MLI', orderBy: 'GROSS_SALES_MLI DESC', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    var gglData = dataArrayCPTH(result.d);
        ...
        function setLabelGrowthTH() {
            $.ajax({
                type: "POST",
                url: "/Dashboard/ChartService.asmx/getGrowth_PRI_TH",
                data: "{ filter: '' , colFilter: 'REGION', colSum: 'GROSS_SALES_MLI', table: 'D_YTD_SALES_DATA_PRI_NEW'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    //console.log(result.d);
        ...
        function slMonthChanged(value) {
            google.setOnLoadCallback(function () { classChangeCPTH_PRI(value, "MONTH") });
        }
        ...
        $(() => {
            ...
            $.ajax({
                ...
                data: "{ table:'D_YTD_SALES_DATA_PRI_NEW'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (result) {
                    // console.log(result.d);
            ...
            <ContentTemplate>
                <asp:Panel ID="P5sPnlMain" runat="server">
                    ...
                    <div class="dhb-header">
                        <h4 style="color: #808080"><%=MMV.L5sMaster.L5sLangs["YTD Primary Sales Perfomance - YTD (Mil)"]%></h4>
